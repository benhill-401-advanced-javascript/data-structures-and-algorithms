...
var generateSubmitButton = function () {
    // Solution code here...
...
------------------------------------------------------------------------------------------------ */
var noPunctuation = function (str) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var seashells = 'She sells seashells by the seashore. The shells she sells are surely seashells. So if she sells shells on the seashore, I\'m sure she sells seashore shells.';
var findShells = function (str) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
TESTS
...
describe('Testing challenge 1', function () {
    test('It should add a submit button to the DOM', function () {
        generateSubmitButton();
        expect($('button').text()).toStrictEqual('submit');
    });
});
describe('Testing challenge 2', function () {
    test('It should return true if the input is a number', function () {
        expect(isNum(1234567890)).toBeTruthy();
        expect(isNum('12345')).toBeTruthy();
    });
    test('It should return true if the input contains a number', function () {
        expect(isNum('h3llo w0rld')).toBeTruthy();
    });
    test('It should return false if the input does not contain a number', function () {
        expect(isNum('hello world')).toBeFalsy();
        expect(isNum('')).toBeFalsy();
    });
});
describe('Testing challenge 3', function () {
    test('It should only return words that begin with a capital letter', function () {
        var capitalResult = isCapitalized('We only want to Return the Words that begin With a capital Letter');
...
describe('Testing challenge 4', function () {
    var cities = ['Cleveland', 'San Diego', 'Birmingham', 'Seattle', 'Miami', 'New York City', 'Omaha', 'Portland', 'Austin', 'Boston', 'Newport Beach', 'Hoboken'];
    test('It should return the cities whose names begin with the letters A through J', function () {
    ...
    test('It should not return the cities whose names begin with the letters K through Z', function () {
...
xdescribe('Testing challenge 5', function () {
    test('It should match any of the acceptable inputs', function () {
        expect(matchMonth('Oct')).toBeTruthy();
        expect(matchMonth('oct')).toBeTruthy();
        expect(matchMonth('October')).toBeTruthy();
        expect(matchMonth('october')).toBeTruthy();
    });
    test('It should not match anything other than the acceptable inputs', function () {
...
xdescribe('Testing challenge 6', function () {
    var lorem = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lacinia vel massa sed egestas. Nunc faucibus iaculis elit, a scelerisque enim condimentum sed. Aenean ac scelerisque sem, et pharetra diam.';
    test('It should only return words that are immediately followed by a space', function () {
    ...
    test('It should not contain words that are followed by any non-space character', function () {
...
xdescribe('Testing challenge 7', function () {
    var startString = 'This is a regex challenge. We are trying to create a hangman phrase where all of the vowels are missing!';
    test('It should remove the vowels from the hangman string and replace them with underscores', function () {
    ...
    test('It should not contain the letters "a", "e", "i", "o", or "u"', function () {
        expect(hangman(startString)).not.toContain('a', 'e', 'i', 'o', 'u');
    });
});
xdescribe('Testing challenge 8', function () {
    test('It should return an array of instances of "sells", shells", and "seashells"', function () {
