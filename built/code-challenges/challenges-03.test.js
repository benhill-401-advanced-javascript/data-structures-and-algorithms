...
var changeAllClassNames = function () {
    // Solution code here...
    $('li').addClass('fruit');
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var sortBackwards = function (arr) {
    // Solution code here...
...
------------------------------------------------------------------------------------------------ */
var alphabetizeBetter = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var sortNumbersByLength = function (arr) {
    // Solution code here...
};
/*-----------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var sortPeopleBetter = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
var sortMeetingsByDay = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
describe('Testing challenge 1', function () {
    test('It should add a class of fruit to all the list items', function () {
        changeAllClassNames();
...
describe('Testing challenge 2', function () {
    test('It should sort high-to-low the numbers in an array', function () {
        var nums = [3, 4, 5, 6, 7];
...
describe('Testing challenge 3', function () {
    test('It should sort strings alphabetically', function () {
...
describe('Testing challenge 4', function () {
    test('It should sort strings by length', function () {
        var ans = sortByLength(['alphabet', 'Zebra', 'Alphabet', 'carrot']);
...
xdescribe('Testing challenge 5', function () {
    test('It should alphabetize without regard to capitalization', function () {
        expect(alphabetizeBetter(['Alice', 'apple', 'alert', 'Average'])).toStrictEqual(['alert', 'Alice', 'apple', 'Average']);
        var ans = alphabetizeBetter(['alphabet', 'Zebra', 'Alphabet', 'carrot']);
...
xdescribe('Testing challenge 6', function () {
    test('It should sort items by their price', function () {
        expect(sortByPrice([
            { name: 'Sweatshirt', price: 45 },
            { name: 'Bookmark', price: 2.50 },
            { name: 'Tote bag', price: 15 }
...
xdescribe('Testing challenge 7', function () {
    test('It should sort numbers by their length', function () {
...
xdescribe('Testing challenge 8', function () {
    test('It should sort people by their last names', function () {
...
xdescribe('Testing challenge 9', function () {
    test('It should sort people with more strict ordering', function () {
        var family = [
...
xdescribe('Testing challenge 10', function () {
    test('It should sort meetings by the day on which they happen', function () {
        var sortedMeetings = sortMeetingsByDay(meetings);
...
xdescribe('Testing challenge 11', function () {
    test('It should sort meetings by when they happen', function () {
...
xdescribe('Testing challenge 12', function () {
    test('It should add a class of pear to the thrid li', function () {
        addPearClass();
