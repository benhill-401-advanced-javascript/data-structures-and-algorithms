...
------------------------------------------------------------------------------------------------ */
var filterStringsWithVowels = function (arr) {
    // Solution code here...
    var regex = /([aeiou])/gi;
...
------------------------------------------------------------------------------------------------ */
var notInFirstArray = function (forbiddenValues, arr) {
    // Solution code here...`
    var result = arr.filter(function (val) {
...
var getBaseStatGreaterThan = function (arr, minBaseStat) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var getStatName = function (arr, minBaseStat) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
var getCharactersWithoutChildren = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var evenOddNumericValues = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
TESTS
...
describe('Testing challenge 2', function () {
    test('It should return an array containing only odd integers', function () {
...
describe('Testing challenge 3', function () {
    test('It should return an array containing only words that have vowels', function () {
    ...
    test('It should not contain any words that do not contain vowels', function () {
        expect(filterStringsWithVowels(['gregor', 'hound', 'xyz'])).not.toContain('xyz');
    });
});
describe('Testing challenge 4', function () {
    var firstNums = [1, 2, 3];
    var secondNums = [1, 2, 3, 4];
    var firstStrings = ['Demi', 'Gregor', 'Hound'];
    var secondStrings = ['Gary', 'Charlotte', 'Demi', 'Gregor', 'Hound'];
    test('It should return an array that includes any elements not in the first array', function () {
    ...
    test('It should also work with an array of strings', function () {
    ...
    test('It should work with empty arrays', function () {
...
xdescribe('Testing challenge 5', function () {
    test('It should return an array containing the stats that are greater than the input', function () {
    ...
    test('It should work for non-Snorlax data', function () {
...
xdescribe('Testing challenge 6', function () {
    test('It should return the name of the stats that exceed that maximum', function () {
...
xdescribe('Testing challenge 7', function () {
    test('It should return an array containing characters who do not have children', function () {
...
xdescribe('Testing challenge 8', function () {
    test('It should remove non-integers and return "even" or "odd', function () {
    ...
    test('It should not accept strings that look like numbers', function () {
