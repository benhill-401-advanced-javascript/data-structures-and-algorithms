...
------------------------------------------------------------------------------------------------ */
var raisedToTheThird = function (arr) {
    var Array = [];
...
------------------------------------------------------------------------------------------------ */
var appendFirstToLast = function (arr) {
    // Solution code here...
    arr.push(arr[0]);
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var addBirthYearProperty = function (obj, year) {
    // Solution code here...
    obj.yearBorn = year;
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var setStatusAsAuthor = function (people) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
describe('Testing challenge 1', function () {
    test('It should return a new array of numbers raised to the thrid power', function () {
        expect(raisedToTheThird([2, 4, 5, -7, 0])).toStrictEqual([8, 64, 125, -343, 0]);
    });
});
describe('Testing challenge 2', function () {
    test('It should append without modifying the oiginal', function () {
        var a = 'This is my story.';
        var b = appendTheEnd(a);
...
describe('Testing challenge 3', function () {
    test('It should append by modifying the oiginal', function () {
        var a = ['Yes', 'it', 'is'];
        appendFirstToLast(a);
...
describe('Testing challenge 4', function () {
    test('It should add a property to an object', function () {
        var a = { fullName: 'Octavia Butler' };
        addBirthYearProperty(a, 1947);
        expect(a.yearBorn).toStrictEqual(1947);
    });
});
xdescribe('Testing challenge 5', function () {
    test('It should add a property to every object in an array', function () {
        var a = [{ fullName: 'Octavia Butler' }, { fullName: 'Ray Bradbury' }, { fullName: 'Kurt Vonnegut' }];
        setStatusAsAuthor(a);
...
xdescribe('Testing challenge 6', function () {
    test('It should append the second array to the first', function () {
        var a = [1, 2, 3, 4];
        var b = [5, 6, 7, 8];
        append(a, b);
