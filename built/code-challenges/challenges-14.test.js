...
var biggerThanLuke = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
------------------------------------------------------------------------------------------------ */
var sortBy = function (property, arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var detectTicTacToeWin = function (board) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
TESTS
...
describe('Testing challenge 2', function () {
    test('It should convert each word to title case', function () {
        var words = ['apple', 'banana', 'MacGyver'];
...
describe('Testing challenge 3', function () {
    test('It should return only characters that are bigger than Luke', function () {
...
describe('Testing challenge 4', function () {
    test('It should sort items by a price', function () {
        expect(sortBy('price', [
            { name: 'Sweatshirt', price: 45 },
            { name: 'Bookmark', price: 2.50 },
            { name: 'Tote bag', price: 15 }
    ...
    test('It should sort items by name', function () {
        expect(sortBy('name', [
            { name: 'Sweatshirt', price: 45 },
            { name: 'Bookmark', price: 2.50 },
            { name: 'Tote bag', price: 15 }
...
describe('Testing challenge 5', function () {
    test('It should check if url is https', function () {
...
describe('Testing challenge 6', function () {
    test('It should return true if there are three in a row', function () {
        expect(detectTicTacToeWin([['X', '', 'O'], ['X', 'O', ''], ['X', 'O', 'X']])).toStrictEqual(true);
        expect(detectTicTacToeWin([['O', '', 'X'], ['X', 'O', 'X'], ['X', '', 'O']])).toStrictEqual(true);
    });
    test('It should return false if there are not three in a row', function () {
        expect(detectTicTacToeWin([['X', '', 'O'], ['O', 'O', ''], ['X', 'O', 'X']])).toStrictEqual(false);
    });
    test('It should not treat empty 3 in row as winner', function () {
