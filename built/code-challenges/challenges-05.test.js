...
var templateWithJQuery = function () {
    // Solution code here...
...
------------------------------------------------------------------------------------------------ */
var howMuchPencil = function (str) {
    // Solution code here...
    var result = [];
...
------------------------------------------------------------------------------------------------ */
var wordsToCharList = function (arr) {
    // Solution code here...
...
var listFoods = function (recipe) {
    // Solution code here...
    var result = [];
    recipe.ingredients.forEach(function (value) {
        var str1 = value.slice(value.indexOf('') + 1);
...
------------------------------------------------------------------------------------------------ */
var splitFoods = function (recipe) {
    var result = [];
    // Solution code here...
    return result;
};
...
------------------------------------------------------------------------------------------------ */
var stepActions = function (recipe) {
    var result = [];
    // Solution code here...
    return result;
};
...
------------------------------------------------------------------------------------------------ */
var removeEvenValues = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var removeLastCharacters = function (str, numberOfCharacters) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var extractVowels = function (str) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
TESTS
...
describe('Testing challenge 1', function () {
    test('It should append the star wars people to the DOM', function () {
        templateWithJQuery();
...
describe('Testing challenge 2', function () {
    test('It should return a list of shortening words', function () {
...
describe('Testing challenge 3', function () {
    test('It should return an array of individual letters', function () {
...
describe('Testing challenge 4', function () {
    test('It should return a list of foods', function () {
...
xdescribe('Testing challenge 6', function () {
    test('It should return a list of recipe steps', function () {
        expect(stepActions(gruffaloCrumble)).toStrictEqual(['Pre-heat', 'De-prickle', 'Sprinkle', 'Mix', 'Grease', 'Combine', 'Fold', 'Spread', 'Bake']);
        expect(stepActions(gruffaloCrumble).length).toStrictEqual(9);
    });
});
xdescribe('Testing challenge 7', function () {
    test('It should remove the even numbers from the array', function () {
...
xdescribe('Testing challenge 8', function () {
    test('It should shorten the string based on the first argument', function () {
        expect(removeLastCharacters('Gregor', 2)).toStrictEqual('Greg');
        expect(removeLastCharacters('Gregor', 2).length).toStrictEqual(4);
    });
    test('It should return the complete string when passed a negative number', function () {
        expect(removeLastCharacters('hello', -1)).toStrictEqual('hello');
        expect(removeLastCharacters('wowow', -700)).toStrictEqual('wowow');
    });
    test('It should return an empty string when called with a number larger than the string length', function () {
...
xdescribe('Testing challenge 9', function () {
    test('It should add up the numbers contained within the string', function () {
...
xdescribe('Testing challenge 10', function () {
    test('It should return the string without vowels', function () {
