...
------------------------------------------------------------------------------------------------ */
var forLoopTwoToThe = function (arr) {
    // Solution code here...
    var newArray = [];
...
------------------------------------------------------------------------------------------------ */
var forEachTwoToThe = function (arr) {
    // Solution code here...
    var newArray = [];
...
var extractAbilities = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
xdescribe('Testing challenge 5', function () {
    test('It should return an array containing the character code for each letter', function () {
        expect(charCode(['C', 'o', 'd', 'e', '3', '0', '1'])).toStrictEqual([67, 111, 100, 101, 51, 48, 49]);
        expect(charCode(['C', 'o', 'd', 'e', '3', '0', '1']).length).toStrictEqual(7);
    });
});
xdescribe('Testing challenge 6', function () {
    test('It should return an array containing the keys from an object', function () {
        expect(evenOdd([5, 8, 2, 6, 9, 13, 542, 541])).toStrictEqual(['odd', 'even', 'even', 'even', 'odd', 'odd', 'even', 'odd']);
        expect(evenOdd([5, 8, 2, 6, 9, 13, 542, 541]).length).toStrictEqual(8);
    });
    test('It should work with all odd numbers', function () {
        expect(evenOdd([1, 3, 5, 7, 9])).toStrictEqual(['odd', 'odd', 'odd', 'odd', 'odd']);
        expect(evenOdd([1, 3, 5, 7, 9]).length).toStrictEqual(5);
    });
    test('It should work with all even numbers', function () {
        expect(evenOdd([2, 4, 6, 8, 10])).toStrictEqual(['even', 'even', 'even', 'even', 'even']);
        expect(evenOdd([2, 4, 6, 8, 10]).length).toStrictEqual(5);
    });
    test('It should return the string "N/A" if a non-number is included in the array', function () {
...
xdescribe('Testing challenge 7', function () {
    test('It should return an array containing only the ability names', function () {
...
xdescribe('Testing challenge 8', function () {
    test('It should return an array containing objects with name and total values', function () {
