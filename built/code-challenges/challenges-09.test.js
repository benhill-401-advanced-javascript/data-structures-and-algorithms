...
function getCurrentEvents(request, response) {
    // Solution code here...
    var finalOutput = mapCurrentEvents(currentEvents);
    response.status(200).send(finalOutput);
}
var mapCurrentEvents = function () {
    // Solution code here...
    var result = currentEvents.news.map(function (obj) {
        var output = new Event(obj);
        return output;
    });
    return result;
};
...
------------------------------------------------------------------------------------------------ */
var countNumberOfElements = function (arr) {
    // Solution code here...
    var length = arr.reduce(function (accumulator) {
...
var countNumberOfChildren = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
var countPrimeNumbers = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
var extractStat = function (statName, arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
var extractChildren = function (arr) {
    // Solution code here...
};
/* ------------------------------------------------------------------------------------------------
TESTS
...
describe('Testing challenge 1', function () {
    test('It should return an array of object instances with a key of author', function () {
        expect(mapCurrentEvents()[0].author).toStrictEqual('go');
    });
    test('It should return an array of object instances with a key of categories', function () {
...
describe('Testing challenge 2', function () {
    test('It should return the length of the array', function () {
        expect(countNumberOfElements([1, 2, 3, 4, 5])).toStrictEqual(5);
    });
});
describe('Testing challenge 3', function () {
    test('It should return an array continaing the names of the characters', function () {
        expect(returnNames(starWarsData)).toStrictEqual(['Luke Skywalker', 'C-3PO', 'R2-D2', 'Darth Vader', 'Leia Organa']);
        expect(returnNames(starWarsData).length).toStrictEqual(5);
    });
});
describe('Testing challenge 4', function () {
    test('It should return the string with the characters in reverse order', function () {
        expect(reversedString('Code 301')).toStrictEqual('103 edoC');
    });
});
describe('Testing challenge 5', function () {
    test('It should return the total number of children', function () {
        expect(countNumberOfChildren(characters)).toStrictEqual(14);
    });
});
xdescribe('Testing challenge 6', function () {
    test('It should return the average of the numbers in the array', function () {
        expect(calculateAverage([18, 290, 37, 4, 55, 16, 7, 85])).toStrictEqual(64);
    });
});
describe('Testing challenge 7', function () {
    test('It should return a count of the prime numbers in the array', function () {
        expect(countPrimeNumbers([1, 2, 13, 64, 45, 56, 17, 8])).toStrictEqual(3);
    });
});
describe('Testing challenge 8', function () {
    test('It should return any stats that match the input', function () {
...
describe('Testing challenge 9', function () {
    test('It should return an array containing the names of the children', function () {
